...
| :---: | :---: | :--- | :--- | :--- | :---: |
| **01** | *DD/MM/AAAA* | Inicialización del repositorio y configuración de la bitácora | Equipo | Repositorio creado exitosamente | ✅ Completado |
...
- [ ] Registrar la primera sesión de taller.
